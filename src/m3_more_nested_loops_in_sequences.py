...
def run_test_largest_number():
    ...
    expected = 56
    answer = largest_number(([1,3,5,3,2,56,32], [3,4,1,2,5,6], [16,54,23,43]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    print('-------------------------------------------------')
    expected = -1
    answer = largest_negative_number(([2,3,5,1,2], [-3,4,1,2,6,-1], [2,5,4,3]))
    print('Expected and actual are:', expected, answer)

    expected =None
    answer = largest_negative_number(([1,2,3,4,5], [5,4,3,2,1], []))
    print('Expected and actual are:', expected, answer)

    expected =-5
    answer = largest_negative_number(([98,35,42], [3,-5]))
    print('Expected and actual are:', expected, answer)

    expected =-2
    answer = largest_negative_number(([2,3,1,2,5], [-7,-3,-2,-8], [0]))
    print('Expected and actual are:', expected, answer)

    expected =-10
    answer = largest_negative_number(([3,2,4,3], [5,7,6,4,-32], [1,2,4],[-10,5,-34]))
    print('Expected and actual are:', expected, answer)
